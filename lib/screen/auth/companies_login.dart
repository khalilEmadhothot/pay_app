...
class CompaniesLogin extends StatefulWidget {
  const CompaniesLogin({Key? key}) : super(key: key);

  @override
  State<CompaniesLogin> createState() => _CompaniesLoginState();
}

class _CompaniesLoginState extends State<CompaniesLogin> {
