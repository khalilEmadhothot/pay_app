...
class _ClientLoginState extends State<ClientLogin> {
  ...
  late TextEditingController _BuyerNoTextController;
  ...
  void initState() {
    ...
    _BuyerNoTextController = TextEditingController();
  ...
  void dispose() {
    ...
    _BuyerNoTextController.dispose();
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            WidgetTextFaildCompanies(
              text: 'amount',
              fierstnameTextController: _amountTextController,
            ),
            SizedBox(
              height: 16.h,
            ),
