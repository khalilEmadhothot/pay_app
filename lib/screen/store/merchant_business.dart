...
class MerchantBusiness extends StatefulWidget {
  const MerchantBusiness({Key? key}) : super(key: key);

  @override
  State<MerchantBusiness> createState() => _MerchantBusinessState();
}

class _MerchantBusinessState extends State<MerchantBusiness> {
  @override
...
Padding(
  padding: const EdgeInsetsDirectional.only(top: 20),
  child:   IconButton(onPressed: (){}, icon: Icon(Icons.account_circle_outlined,color: Colors.black87,size: 23,)),
)
                  ],
                ),
              ),
